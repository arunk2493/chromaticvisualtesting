let execSync,setupDebug,gql,dedent,EOL;_3da‍.x([["FETCH_N_INITIAL_BUILD_COMMITS",()=>FETCH_N_INITIAL_BUILD_COMMITS],["getCommit",()=>getCommit],["getBranch",()=>getBranch],["getBaselineCommits",()=>getBaselineCommits],["isUpToDate",()=>isUpToDate],["isClean",()=>isClean],["getUpdateMessage",()=>getUpdateMessage],["findMergeBase",()=>findMergeBase],["checkout",()=>checkout],["checkoutPrevious",()=>checkoutPrevious],["discardChanges",()=>discardChanges]]);_3da‍.w("child_process",[["execSync",["execSync"],function(v){execSync=v}]]);_3da‍.w("debug",[["default",["setupDebug"],function(v){setupDebug=v}]]);_3da‍.w("fake-tag",[["default",["gql"],function(v){gql=v}]]);_3da‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_3da‍.w("os",[["EOL",["EOL"],function(v){EOL=v}]]);

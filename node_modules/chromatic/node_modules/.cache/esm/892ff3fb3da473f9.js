let envCi,dedent,setupDebug,getCommit,getBranch,log;_3da‍.x([["debug",()=>debug],["getCommitAndBranch",()=>getCommitAndBranch]]);_3da‍.w("env-ci",[["default",["envCi"],function(v){envCi=v}]]);_3da‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_3da‍.w("debug",[["default",["setupDebug"],function(v){setupDebug=v}]]);_3da‍.w("./git",[["getCommit",["getCommit"],function(v){getCommit=v}],["getBranch",["getBranch"],function(v){getBranch=v}]]);_3da‍.w("../lib/log",[["default",["log"],function(v){log=v}]]);

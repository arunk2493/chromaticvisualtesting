_3da‍.x([["addShimsToJSDOM",()=>addShimsToJSDOM]]);/* eslint-disable @typescript-eslint/no-empty-function, max-classes-per-file, no-param-reassign */
...
function mockSVG(window) {
  ...
  svgElements.forEach(e => {
    if (!window[e]) {
      ...
      const Value = _3da‍.u(eval(_3da‍.c(`(class ${e} extends window.HTMLElement {})`)));
